...
app_ui = ui.page_fluid(
    ...
    ui.input_slider("hour_range", "Hour of the Day", 0, 23, (0, 3)), 
...
def server(input, output, session):
    ...
    def my_plot():
        ...
        # Extract the start and end hour from the selected range
        ...
        ax.set_title(f'Scatter Plot of {selected_type_subtype} Cases from {start_hour:02}:00 to {end_hour:02}:00')
